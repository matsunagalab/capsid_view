...
const structures = [
    ...
    {
        id: '1vb4_interface',
        name: '1VB4 (T1 | Sesbania Mosaic Virus | Solemoviridae | Sobemovirus)',
        url: 'https://files.rcsb.org/download/1VB4.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T1/1vb4_interface.molx', 
    },
    {
        id: '5zju_interface',
        name: '5ZJU (T1 | PCV2 V| Circoviridae | Circovirus)',
        url: 'https://files.rcsb.org/download/5ZJU.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T1/5zju_interface.molx', 
    },
    {
        id: '1m1c_interface',
        name: '1M1C (T2 | L-A virus | Totiviridae | Totivirus)',
        url: 'https://files.rcsb.org/download/1M1C.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T2/1m1c_interface.molx', 
    },
    {
        id: '6z8d_interface',
        name: '6Z8D (T2 | Human Picobirnavirus | Picobirnaviridae | Orthopicobirnavirus)',
        url: 'https://files.rcsb.org/download/6Z8D.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T2/6z8d_interface.molx', 
    },
    {
        id: '4btq_interface',
        name: '4BTQ (T2 | phi6 | Cystoviridae | Cystovirus)',
        url: 'https://files.rcsb.org/download/4BTQ.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T2/4btq_interface.molx', 
    },
    {
        id: '4btg_interface',
        name: '4BTG (T2 | phi6 | Cystoviridae | Cystovirus)',
        url: 'https://files.rcsb.org/download/4BTG.pdb',
        format: 'pdb',
        tag: ['interface'],
        snapshot: 'https://raw.githubusercontent.com/matsunagalab/capsid_view/main/snapshots/T2/4btg_interface.molx', 
    },
    {
        id: '1vb4_chainbow',
        name: '1VB4 (T1 | Sesbania Mosaic Virus | Solemoviridae | Sobemovirus)',
